...
if __name__ == "__main__":
    ...
    agnostic_path = './outputs/version_dp_maximum_score_0.6_n_spp_div4/freevocab_results/' + scene_id + '.pth'



    pyviz3d_dir = './outputs/viz' # visualization directory
    ...
    if check_finalviz:
        VIZ.finalviz(agnostic_path, specific = True, vocab = "freevocab")
